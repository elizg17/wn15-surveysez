 ...
 * 
 * @package SurveySez
 * @author Beth Griffith<egriff04@seattlecentral.edu>
 * @version 1.0
 * @link http://www.newmanix.com/
 * @
 * @see survey_view.php
 * @see Pager_inc.php 
 * @todo Create survey_view page.php page 
 */
...
$config->metaKeywords = 'Surveys,PHP,Fun,Questions,Regular,Information,Customer Data,'. $config->metaKeywords;
...
<p>This page is the entry point of the application, meaning this page gets a link on your web site.  Since the current subject is muffins, we could name the link something clever like <a href="<?php echo VIRTUAL_PATH; ?>survey_list.php">Survey</a></p>
